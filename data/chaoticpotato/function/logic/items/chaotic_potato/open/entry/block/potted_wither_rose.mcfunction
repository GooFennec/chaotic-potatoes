## chaotic_potato - entries - block/potted_wither_rose
# visuals
...
# variants
execute unless block ~ ~ ~ #chaoticpotato:_g/indestructibles run return run setblock ~ ~ ~ minecraft:potted_wither_rose destroy
summon minecraft:item ~ ~ ~ {Item:{id:"minecraft:wither_rose",count:1},PickupDelay:20,Motion:[0.0,0.2,0.0]}
