## dice - land/got/low
# display
item modify entity @s contents chaoticpotato:items/dice/got/low
...
# perks
execute if score @s cp.dataA matches 1 on origin at @s run function chaoticpotato:logic/items/dice/land/perk/negative