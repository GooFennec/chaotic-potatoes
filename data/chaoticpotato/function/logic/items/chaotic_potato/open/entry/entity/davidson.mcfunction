## chaotic_potato - open/entries - entity/davidson
summon minecraft:cat ~ ~ ~ {CustomName:'[{"text":"Davidson","color":"yellow"}]',CustomNameVisible:1b,Tags:["cp.e.davidson"],variant:"minecraft:black"}
