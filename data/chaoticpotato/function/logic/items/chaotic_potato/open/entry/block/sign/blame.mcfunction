## chaotic_potato - entries - block/sign/blame
# prepare
...
data merge block ~ ~ ~ {back_text:{has_glowing_text:1b,color:"black",messages:['""','"the potatoes"','"did this..."','""']},front_text:{has_glowing_text:1b,color:"black",messages:['""','"the potatoes"','"did this..."','""']},is_waxed:1b}