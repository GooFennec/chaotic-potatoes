...
# visuals
tellraw @s [{"text":" [> ","color":"dark_aqua"},{"text":"You rolled a ","color":"white"},{"text":"[","color":"gold"},{"text":"1","color":"red"},{"text":"]","color":"gold"},{"text":", nerf applied.","color":"white"}]
playsound minecraft:entity.illusioner.cast_spell player @s ~ ~ ~ 1.0 1.7
playsound minecraft:block.beacon.deactivate player @s ~ ~ ~ 1.0 2.0
# randomize
...
loot replace entity @n[type=minecraft:item_display,tag=cp.i.dice,tag=cp.d.random] contents loot chaoticpotato:items/dice/perk/negative
