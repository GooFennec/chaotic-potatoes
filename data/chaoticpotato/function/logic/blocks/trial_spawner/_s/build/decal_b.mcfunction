...
execute if score @s cp.dataA matches 5 run return run setblock ~ ~ ~ minecraft:bone_block destroy
...
execute if score @s cp.dataA matches 8 run return run setblock ~ ~ ~ minecraft:mossy_cobblestone destroy
execute if score @s cp.dataA matches 9 run return run setblock ~ ~ ~ minecraft:stone destroy
