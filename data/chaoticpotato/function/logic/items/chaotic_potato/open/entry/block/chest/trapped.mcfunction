## chaotic_potato - entries - block/chest/trapped
# visuals
...
# variants
execute unless block ~ ~ ~ #chaoticpotato:_g/indestructibles run return run function chaoticpotato:logic/blocks/fake_chest/_p/summon/c/trapped
