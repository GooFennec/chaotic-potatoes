...
# offset
scoreboard players add @s cp.mathA 1
# build
data modify block ~ ~ ~ cursors prepend value {charge:7,pos:[I;0,0,0],decay_delay:1,update_delay:0,facings:["west"]}
